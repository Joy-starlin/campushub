            ...
            >
              <div className="p-4 bg-white/80 backdrop-blur-md border-b border-gray-100 flex items-center justify-between">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-sm font-bold text-gray-700 uppercase tracking-wider">Live Campus View</span>
                </div>
                <a 
                ...
                >
                  OPEN IN EXTERNAL APP <ArrowUpRight className="ml-1 w-3 h-3" />
                </a>
              </div>
              <div className="h-[450px] w-full">
                <iframe
                  title="Bugema University Map"
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m13!1d15958.0772737604!2d32.6104!3d0.5847!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x177da3b8d1b60f3b%3A0xb3b2f6eaf7a8b!2sBugema%20University!5e0!3m2!1sen!2sug!4v1620000000000"
                  width="100%"
                  height="100%"
                  style={{ border: 0 }}
                  allowFullScreen
